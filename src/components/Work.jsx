                            ...
                            <div className="work-grid-card__side work-grid-card__side--back work-grid-card__side--back-5">
                                <div className="work-grid-card__cta">
                                    <p className="work-grid-card__description">
                                        Portfolio for a small carpenter company
                                        with hidden admin route
                                    </p>
                                    <div
                                        onClick={() => {
                                            this.setState({
                    ...
                    <div className="work-grid-card-container">
                        <div className="work-grid-card">
                            ...
                            <div className="work-grid-card__side work-grid-card__side--back work-grid-card__side--back-4">
                                <div className="work-grid-card__cta">
                                    <p className="work-grid-card__description">
                                        Social Media for exercise enthusiasts.
                    ...
                    <div className="work-grid-card-container">
                        <div className="work-grid-card">
                            ...
                            <div className="work-grid-card__side work-grid-card__side--back work-grid-card__side--back-1">
                                <div className="work-grid-card__cta">
                                    <p className="work-grid-card__description">
                                        Social media for Foreign Exchange
                                        Traders that allows users to visualize
                                        their performance using charts.
                                    </p>
                                    <div
                                        onClick={() => {
                                            this.setState({
                        ...
                        <div className="work-popup-content">
                            ...
                            <div className="work-popup-info">
                                <div className="work-popup-info-text">
                                    This project taught me about working with a
                                    client who had no previous online exposure
                                    aside from an offerup store. I made their
                                    name, logo, website, video, and social
                                    medias.
                                </div>
                        ...
                        <div className="work-popup-content">
                            ...
                            <div className="work-popup-info">
                                <div className="work-popup-info-text">
                                    ...
                                    Firebase's realtime database and handling
                                    the global state using Redux.
                                </div>
                                <div className="work-popup-info-btns">
                                    <a
                    ...
                    <div className="work-popup">
                        <div className="work-popup-content">
                            ...
                            <div className="work-popup-info">
                                ...
                                />
                                <div className="work-popup-info-text">
                                    This project taught me about authentication,
                    ...
                    <div className="work-popup">
                        <div className="work-popup-content">
                            ...
                            <div className="work-popup-info">
                                ...
                                />
                                <div className="work-popup-info-text">
                                    This project taught me about fetching data
                                    from APIs and Web Scraping.
                                </div>
                                <div className="work-popup-info-btns">
                                    <a
